    ...
    >
      <el-row>
        ...
        >
          ...
          ><span style="font-size:14px;position: absolute;left: 0px;width: 100px;
    font-weight: bolder;">上传图片:</span></i>
          <div class="el-upload__text" style="margin-bottom:20px;">上传图片说明：格式支持 .jpg .jpeg .png等</div>
        </el-upload>
        <template v-for="(item, index) in formItem">
          ...
          >
            <el-form-item
              ...
              :prop="item.name"
              :rules="item.name !== 'phone'?item.rules:phoneVal"
            ...
            >
              ...
              <!-- 输入框 -->
              <el-input
                v-else-if="item.type === 'text' && item.name !== 'phone'"
                v-model="formData[item.name]"
                :type="item.type"
