...
export default {
  ...
  methods: {
    viewFun(item) {
      ...
      this.gotoUrl("/contentManage/huaHall/huaHallView", params);
    ...
    addFun() {
      this.gotoUrl("/contentManage/huaHall/huaHallAppend", {
        menuId: this.$route.query.menuId + ""
      });
      this.$route.matched[this.$route.matched.length - 1].name =
        "渭华讲堂-添加";
    ...
    update(row) {
      row.menuId = !!this.$route.query.menuId
        ? this.$route.query.menuId + ""
        : this.$route.name;
      this.gotoUrl("/contentManage/huaHall/huaHallAppend", row);
      this.$route.matched[this.$route.matched.length - 1].name =
        "渭华讲堂-编辑";
    },
    // 获取数据
