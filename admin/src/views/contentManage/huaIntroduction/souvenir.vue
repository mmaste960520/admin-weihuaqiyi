...
export default {
  ...
  methods: {
    viewFun(item) {
      ...
      let toUrl = "";
      if (this.$route.query.menuId == "10004007") {
        //研究著论
        toUrl = "/contentManage/huaIntroduction/studyView";
      } else if (this.$route.query.menuId == "10004006") {
        //历史资料
        toUrl = "/contentManage/huaIntroduction/historyDataView";
      } else if (this.$route.query.menuId == "10004008") {
        //影音作品
        toUrl = "/contentManage/huaIntroduction/VideoWorksView";
      } else {
        toUrl = "/contentManage/huaIntroduction/souvenirView"; //回忆纪念
      }
      this.gotoUrl(toUrl, params);
    },
    ...
    addFun() {
      ...
      if (this.$route.query.menuId == "10004007") {
        //研究著论
        toUrl = "/contentManage/huaIntroduction/studyAdd";
      } else if (this.$route.query.menuId == "10004006") {
        //历史资料
        toUrl = "/contentManage/huaIntroduction/historyDataAdd";
      } else if (this.$route.query.menuId == "10004008") {
        //影音作品
        toUrl = "/contentManage/huaIntroduction/VideoWorksAdd";
      } else {
        toUrl = "/contentManage/huaIntroduction/souvenirAdd"; //回忆纪念
      }
      this.gotoUrl(toUrl, {
        menuId: this.$route.query.menuId
      });
    ...
    update(row) {
      ...
      if (this.$route.query.menuId == "10004007") {
        //研究著论
        toUrl = "/contentManage/huaIntroduction/studyUpdate";
      } else if (this.$route.query.menuId == "10004006") {
        //历史资料
        toUrl = "/contentManage/huaIntroduction/historyDataUpdate";
      } else if (this.$route.query.menuId == "10004008") {
        //影音作品
        toUrl = "/contentManage/huaIntroduction/VideoWorksUpdate";
      } else {
        toUrl = "/contentManage/huaIntroduction/souvenirUpdate"; //回忆纪念
      }
      this.gotoUrl(toUrl, params);
    },
    // 弹框关闭时的回调函数
