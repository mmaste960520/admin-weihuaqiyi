    ...
    >
      ...
      >
        <el-button
          ...
          @click="gotoUrl('/contentManage/knowledgeAnswer/knowledgeAnswerAppend',{menuId: $route.query.menuId})"
        >添加试题</el-button>
        <el-button
          type="primary"
          size="mini"
...
export default {
  ...
  data() {
    ...
    // 表格操作配置
    var operation = {
      nowPage: "knowledgeAnswer",
      show: true,
      fixed: false,
      size: "mini",
      width: 80 + rem2px(px2rem(190)),
      minWidth: 100,
      label: "操作",
      btns: [
         {
  ...
  methods: {
    ...
    viewFun(item) {
      ...
      this.gotoUrl(
        "/contentManage/knowledgeAnswer/knowledgeAnswerAppend",
        item
      );
    },
    // 获取数据
