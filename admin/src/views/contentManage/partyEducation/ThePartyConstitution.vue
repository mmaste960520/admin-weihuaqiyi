...
export default {
  ...
  methods: {
    ...
    changeMenu(addOrUpdate) {
      ...
      ].name = !!sessionStorage.getItem("firstPreMenu")
        ? sessionStorage.getItem("firstPreMenu") + "-" + addOrUpdate
        : !!sessionStorage.getItem("preMenu")
        ? sessionStorage.getItem("preMenu") + "-" + addOrUpdate
        : this.$route.matched[this.$route.matched.length - 1].name;
    },
    addFun() {
      this.gotoUrl("/contentManage/partyEducation/partyEducationAdd", {
