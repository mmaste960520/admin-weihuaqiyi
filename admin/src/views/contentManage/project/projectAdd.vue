...
import twoColumForm from "@/views/contentManage/project/twoColumForm";
      ...
      pageItem: [
        {
          ...
          radio: [
            { label: "PC", name: "templateId", value: "1" },
            { label: "APP", name: "templateId", value: "2" },
            { label: "小程序", name: "templateId", value: "3" },
            { label: "后台管理系统", name: "templateId", value: "4" }
          ],
          radioValue: "3",
          formData: {
            buttonShow: false
