...
export default {
  ...
  methods: {
    ...
    searchFormInit() {
      ...
      this.searchFormData.start = "";
      this.searchFormData.end = "";
    },
    ...
    addFun() {
      this.gotoUrl("/contentManage/redEducation/redEducationAdd", {
    ...
    update(row) {
      ...
      this.gotoUrl("/contentManage/redEducation/redEducationAdd", row);
      this.changeMenu("编辑");
    },
    // 弹框关闭时的回调函数
    handleClose(done) {
