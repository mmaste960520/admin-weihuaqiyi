    ...
    >
      ...
      >
        <el-button
          ...
          @click="gotoUrl('/contentManage/senceNews/informAdd')"
...
export default {
  ...
  methods: {
    viewFun(item) {
      ...
      this.gotoUrl("/contentManage/senceNews/informView", params);
    },
    ...
    update(row) {
      ...
      this.gotoUrl("/contentManage/senceNews/informUpdate", params);
    },
    // 弹框关闭时的回调函数
    handleClose(done) {
      done();
