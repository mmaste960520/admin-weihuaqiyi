  ...
  <div class="tp">
    <div class="hw_box">
      ...
      <div class="hw_content">
        <div class="hw_con" v-for="(item,index) in items" :key='index' @click="WhHeroesDetailsSubmit(item.id)">
          <!--头像-->
  ...
  import { MessageBox } from 'mint-ui';
    export default {
      ...
      methods:{
        ...
        WhHeroesDetailsSubmit(val){
          this.$router.push({
            path: '/WhHeroesDetails',//卫华英烈详情
            query: {
              id: val,
              menuId: '10005001'
            }
        ...
        getprev(){
          ...
          this.$axios({
            method:'post',
            url:'syx/xianlieshijiWeihuayinglie/search',
            data:{
              "menuId":"10005001",
            },
          }).then( (res) =>{
