  ...
  <div class="tp">
    <div class="hw_box">
      ...
      <div class="hw_content">
        <div class="hw_con" v-for="(item,index) in items" @click="MemoriesMemorialDetailsSbumit(item.id)">
          <!--头像-->
          <div class="hw_con_img" style="height: 0.8rem;">
            <img :src="item.imgPath" alt="" style="height: 0.6rem; width: 0.6rem; margin-top: 0.1rem;">
          </div>
  ...
  import { MessageBox } from 'mint-ui';
    export default {
      ...
      methods:{
        ...
        MemoriesMemorialDetailsSbumit(val){
          console.log(val)
          this.$router.push({
            path: '/MemoriesMemorialDetails',//回忆纪念-详情
            query: {
              id: val,
              menuId: '10004005'
            }
