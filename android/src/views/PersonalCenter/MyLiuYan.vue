  ...
  <div class="tp">
    <div class="hw_box">
      ...
      <div class="hw_content">
        <div class="hw_con">
          <div class="hw_menu_box"  v-for="(item,index) in items" @click="DetailsSubmit(item.content,item.id,item.replyMessage)">
            <div class="hw_menu_left">
              <div class="hw_icobg">
                <img src="@/assets/img/ico_myliuyan.png" alt="" />
              </div>
  ...
  import { MessageBox } from 'mint-ui';
    export default {
      ...
      methods:{
        ...
        //进入详情
        DetailsSubmit(val,Val,ha){
          this.$router.push({
            path: '/MyLiuYanDetails',//留言-详情
            query: {
              content: val,
              id: Val,
              replyMessage: ha,
          ...
          this.$axios({
            ...
            if (res) {
              if (res.data.code === 20000) {
                //成功请求
                _this.items = res.data.data.liuyan;
              } else {
                //请求失败
