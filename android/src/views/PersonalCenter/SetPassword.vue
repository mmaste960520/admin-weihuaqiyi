    ...
    <div class="tp">
      <div class="hw_box">
        ...
        <div class="hw_content">
            ...
            <!-- 确认按钮 -->
            <button id="btn" @click="SetPasswordSubmit()">确 定</button>
        </div>
      </div>
    </div>
</template>
    ...
    export default {
      ...
      methods:{
        ...
        SetPasswordSubmit(){ //设置密码
          var _this = this;
          if (!/^((1[3,5,8][0-9])|(14[5,7])|(17[0,6,7,8])|(19[7]))\d{8}$/.test(_this.userphone)) {
            MessageBox('提示', '请输入正确手机号');
          } else if (_this.pwd.length < 5) {
